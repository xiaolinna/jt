...
public class HttpClientConfig {
	...
	public RequestConfig.Builder getBuilder(){
		...
		return builder.setConnectTimeout(connectTimeout)	//创建链接的最大时间
					  .setConnectionRequestTimeout(connectionRequestTimeout)	//链接获取超时时间
					  .setSocketTimeout(socketTimeout)	//数据传输最长时间
					  .setStaleConnectionCheckEnabled(staleConnectionCheckEnabled);	//提交时检查链接是否可用
	}
